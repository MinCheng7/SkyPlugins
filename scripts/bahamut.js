...
1. 该脚本需要进入插件填写账号密码后, 方可使用.
2. 不建议在凌晨执行,因需要获取动画疯题目答案; 默认配置将在每天的早上10:00执行.
...
[Script]
cron "0 10 * * *" script-path=https://raw.githubusercontent.com/MinCheng7/SkyPlugins/refs/heads/main/scripts/bahamut.js, wake-system=1, timeout=300, tag=巴哈姆特签到@MinCheng7
*************************
